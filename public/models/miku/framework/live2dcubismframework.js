    ...
    var Animation = (function () {
        ...
        Animation.prototype.evaluate = function (time, weight, blend, target, stackFlags, groups) {
            ...
            this.parameterTracks.forEach(function (t) {
                if(t.targetId == "PARAM_ANGLE_X" ||t.targetId == "PARAM_ANGLE_Y" || t.targetId == "PARAM_EYE_BALL_X" || t.targetId == "ParamEyeBallX" ||t.targetId == "ParamEyeBallY" ||t.targetId == "PARAM_EYE_BALL_Y" || 
                    t.targetId == "ParamAngleX" || t.targetId == "ParamAngleY" || t.targetId == "ParamAngleZ"||t.targetId == "ParamEyeBallX" || t.targetId == "ParamEyeBallY" 
					||t.targetId == "ParamBodyAngleX"  ||t.targetId == "ParamBodyAngleY" ||t.targetId == "ParamBodyAngleYy" ||t.targetId == "Param_BodyAngle_Y" ||t.targetId == "Param_BodyAngle_Y" ){ return; }
