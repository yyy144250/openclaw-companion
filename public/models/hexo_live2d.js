const live2d_path = "/live2d/assets/";
...
if (screen.width >= 250) {
	Promise.all([
		loadExternalResource("/live2d/js/polyfill.min.js", "js"),
		// loadExternalResource("jquery.min", "js"),
		//loadExternalResource(live2d_path + "waifu/waifu-tipsHome.js", "js"),
		loadExternalResource("/live2d/waifu/waifu.css", "css")
	])
}
